...
public class ProductCategory extends AuditTrail {

    @Column(name = "product_id", nullable = false, columnDefinition = "UUID", length = 36)
    private String productId;

    @Column(name = "category_id", nullable = false, columnDefinition = "UUID", length = 36)
